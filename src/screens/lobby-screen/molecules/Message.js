    ...
    <Grid container direction="row" wrap="nowrap">
      ...
      <Grid container item classes={{ root: classes.marginLeft }}>
        <Grid container item alignItems="baseline">
          ...
          <Typography variant="caption" color="textSecondary" classes={{ root: classes.marginLeft }}> {timestamp} </Typography>
        </Grid>
        <Typography variant="body" classes={{ root: classes.message }}> {message} </Typography>
      </Grid>
    </Grid>
  )
}
